...
import com.coherent.training.selenium.kapitsa.listeners.ExceptionListener;
...
public class NegativeJSonParserTest {
    ...
    private static final String NON_JSON_FILE_PATH = "src/main/resources/com.coherent.training.selenium.kapitsa.cart.html";
